...
Original file is located at
    https://colab.research.google.com/drive/1twPExoi4DQtxdg6tYAhKpv1CW3agqho_
"""
...
class Adverdataset(Dataset):
    def __init__(self, root, label, transforms):
        ...
        # torch.from_numpy() 把numpy转换为tensor
...
class Attacker:
    def __init__(self, img_dir, label):
        ...
        self.dataset = Adverdataset('/content/drive/MyDrive/Hung-yi Lee DLML HW/hw6/data/images', label, transform)
...
if __name__ == '__main__':
    # 讀入圖片相對應的 label
    # loc()取索引号名字为""的一列
    df = pd.read_csv("/content/drive/MyDrive/Hung-yi Lee DLML HW/hw6/data/labels.csv")
    df = df.loc[:, 'TrueLabel'].to_numpy()
    label_name = pd.read_csv("/content/drive/MyDrive/Hung-yi Lee DLML HW/hw6/data/categories.csv")
    label_name = label_name.loc[:, 'CategoryName'].to_numpy()
    # new 一個 Attacker class
    attacker = Attacker('/content/drive/MyDrive/Hung-yi Lee DLML HW/hw6/data/images', df)
    # 要嘗試的 epsilon
    epsilons = [0.1, 0.01]
